...
use embassy_nrf::peripherals::{P0_06, SPI3};
...
async fn main(spawner: Spawner) {
    ...
    let sdmmc_spi = spim::Spim::new(p.SPI3, irq, p.P0_07, p.P0_11, p.P0_08, config);
    let sdmmc_cs = Output::new(p.P0_06, Level::High, OutputDrive::Standard);
